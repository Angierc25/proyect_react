    ...
    <div className="pl-4 border-l border-white/10">
      ...
      {showReply && user && (
        <form onSubmit={handleReplySubmit} className="mb-2">
          ...
          >
            {isPending ? "Publicando..." : "Postear Respuesta"}
          </button>
          {isError && <p className="text-red-500">Error al publicar respuesta</p>}
        </form>
      )}
      ...
      {comment.children && comment.children.length > 0 && (
        <div>
          <button
            ...
            title={isCollapsed ? "Ocultar respuesta" : "Mostrar respuesta"}
          >
            {isCollapsed ? (
              <svg
